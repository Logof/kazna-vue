...
import { type adoLine } from "../../../../api/kazna/ado/index";

const props = defineProps({
  adoLineData: {
    type: Object as PropType<adoLine>,
    default: [],
  },
  isEditable: {
    type: Boolean,
...
const getList = () => {
  if (props.adoLineData !== undefined) {
    tableData.value = props.adoLineData.map((item: adoLine, index: number) => ({ ...item, isEdit: false, rowIndex: index }));
  }
};
getList();
</script>
