...
import { type reasonDocument } from "../../../../api/kazna/ado/index";
...
const getList = () => {
  if (props.reasonDocument !== undefined) {
    tableData.value = props.reasonDocument.map((item: reasonDocument, index: number) => ({ ...item, isEdit: false, rowIndex: index }));
  }
};
getList();
</script>
